...
class Main extends PluginBase implements Listener {
    ...
    public function Menu($sender){ 
        ...
        $form = $api->createSimpleForm(function (Player $sender, int $data = null) {
            ...
            $form->setContent("§eHai, §a{$name} §bSelamat Datang DiPetUI\n§aAuthor §e: §bxpilow§f/§biQuinxy\n §aUang §e: §b{$money}");
            $form->addButton("§aPET SHOP",0,"textures/ui/icon_panda");
            $form->addButton("§cREMOVE PET",0,"textures/ui/trash_light");
            $form->addButton("§eCHANGE PET NAME",0,"textures/ui/text_color_paintbrush");
            $form->addButton("§6TOGGLE PET",0,"textures/ui/touch_glyph");
            $form->addButton("§bNEXT MENU",0,"textures/ui/arrow_active");
    ...
    public function Next($sender){ 
        ...
        $form = $api->createSimpleForm(function (Player $sender, int $data = null) {
            ...
            $form->addButton("§aHEAL PET",0,"textures/ui/icon_winter");
            $form->addButton("§bLEVELUP PET",0,"textures/ui/jump_boost_effect");
            $form->addButton("§ePOINTS PET",0,"textures/ui/icon_minecoin_9x9");
            $form->addButton("§cBACK MENU",0,"textures/ui/undoArrow");
            $form->sendToPlayer($sender);
            return $form;
    }
